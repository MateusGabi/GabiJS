...
function () {
  ...
  _createClass(App, [{
    key: "__dispatchNewStore",
    value: function __dispatchNewStore(store) {
      var newStore = _objectSpread({}, this.__store, store);
...
function () {
  function Component(options) {
    ...
    this.onChangeStore = options.onChangeStore || this.fooLifecicleMethod("onChangeStore");
  ...
  _createClass(Component, [{
    key: "setListeners",
    value: function setListeners(on) {
      for (var event in on) {
        switch (event) {
          case "type":
    ...
    value: function setEventListener(event, callback) {
      var that = this;
      console.log("set on ".concat(event, " in ").concat(this.el));
      this.nativeElement.addEventListener(event, function (e) {
    ...
    value: function setState(newState) {
      ...
      console.log('novo etado', _objectSpread({}, this.state, newState));
      this.renderComponent();
    }
  }, {
    key: "setStore",
    value: function setStore(newStore) {
      this.__dispatchNewStore(_objectSpread({}, newStore));

      this.renderComponent();
    }
  }, {
    key: "__dispatchNewStore",
    value: function __dispatchNewStore(newStore) {
    ...
    value: function fooLifecicleMethod(cicle) {
      ...
      return function () {
        if (_this.debug) {
          console.log("hey, I'm a lifecicle method: ".concat(cicle, "!"));
        }
      };
    }
  }, {
